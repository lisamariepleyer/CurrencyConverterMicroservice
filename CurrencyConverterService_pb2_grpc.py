...
import CurrencyConverterService_pb2 as CurrencyConverterService__pb2


class CurrencyConverterServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.getCurrencyCodes = channel.unary_unary(
                '/CurrencyConverterService.CurrencyConverterService/getCurrencyCodes',
...
def add_CurrencyConverterServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getCurrencyCodes': grpc.unary_unary_rpc_method_handler(
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'CurrencyConverterService.CurrencyConverterService', rpc_method_handlers)
